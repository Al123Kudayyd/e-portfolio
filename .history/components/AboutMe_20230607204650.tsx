  ...
  return (
    <div>
        ...
        <div className='flex items-center justify-center'>
            ...
            />
            <p>Building beautiful, customisable and responsive user <br /> experiences is my passion. I enjoy pushing myself to solve problems and creating solutions that positively affect people.
