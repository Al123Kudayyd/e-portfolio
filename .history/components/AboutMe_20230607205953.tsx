    ...
    <div>
        ...
        <div className='flex items-center justify-around mt-10'>
            ...
            <div className='flex-col pl-10 space-y-4 text-xl font-semibold'>
                <p>
                    Building <span>beautiful</span> , <span></span>  and responsive user <br /> experiences is my passion. I enjoy pushing myself to <br /> solve problems and creating solutions that positively affect people.
                </p>
