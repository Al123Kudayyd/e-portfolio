    ...
    <div>
        ...
        <div className='flex items-center justify-around mt-10'>
            ...
            <div className='flex-col pl-10 space-y-4 text-xl font-semibold'>
                ...
                <p>Currently, I am looking for an <span></span>  as well as an internship <br /> to improve my experiences in <span className='text-purple-500'>frontend engineering</span>.</p>
