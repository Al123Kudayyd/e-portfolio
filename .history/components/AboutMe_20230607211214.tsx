...
function AboutMe() {
  return (
    <div>
        <h1 className='text-center text-4xl font-bold py-10'>About <span className='text-purple-500'>Me.</span></h1>
        <div className='flex items-center justify-around mt-10'>
            ...
            <div className='flex-col pl-10 space-y-4 text-xl font-semibold'>
                ...
                <button className='bg-purple-500 border-purple-500 border-4 px-16 py-2 text-white hover:bg-white hover:text-purple-500 transition duration-300'>Resume</button>
            </div>
