...
function AboutMe() {
  return (
    <div className="p-10">
        ...
        <div className='flex-wrap sm:flex items-center justify-center'>
            <img className='rounded-full px-20 shadow-lg shadow-[black]' src="https://upload.wikimedia.org/wikipedia/commons/a/ac/Default_pfp.jpg" alt="" />
            <div className='flex-col items-center pl-10 space-y-4 text-xl font-semibold'>
                <p>
