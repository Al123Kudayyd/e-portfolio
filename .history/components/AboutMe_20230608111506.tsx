...
function AboutMe() {
  return (
    <div className="p-10">
        ...
        <div className='flex-wrap md:flex items-center justify-center p-10'>
            <Image
            ...
            />
            <div className='flex flex-col md:flex items-center justify-center pl-10 space-y-4 text-xl font-semibold'>
                <p>
                    Building <span className='text-purple-500'>beautiful</span> , <span className='text-purple-500'>customisable</span> and <span className='text-purple-500'>responsive user</span> <br /> experiences is my passion. I enjoy pushing myself to 
