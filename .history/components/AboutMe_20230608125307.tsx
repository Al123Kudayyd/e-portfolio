...
function AboutMe() {
  return (
    <div className="p-10">
        ...
        <div className='grid grid-cols-{1, 1fr, 1fr} items-center justify-center p-10'>
            <Image
            ...
            />
            <div className='flex flex-col items-center justify-center pl-10 space-y-4 text-xl font-semibold'>
                <p>
