...
function Contact() {
  return (
    <div>
        <h1 classNameName='text-center font-bold text-4xl'>Get in <span classNameName='text-purple-500'>Touch!</span></h1>
        ...
        <form className="form " id ="login">
            ...
            <button onclick="checkData()" className="form__button" id="submitForms">Submit</button>
