        ...
        <div className='flex justify-center'>
            <div className='shadow-2xl shadow-[black] mt-16 w-1/2 rounded-xl'>
                <form action="" className='flex flex-col justify-center items-center'>
                    <label className='border-2 border-[#b4b3b3] w-1/2'>
                        <input type="name" placeholder='Name' className='w-full text-xl p-2' />
                    </label>
                    <label className='border-2 border-[#b4b3b3] w-1/2 my-5 '>
                        <input type="email" placeholder='Email' className='w-full text-xl p-2 rounded' />
                    </label>
                </form>
            </div>
        </div>
