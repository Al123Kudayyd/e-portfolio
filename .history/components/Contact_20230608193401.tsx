  ...
  return (
    <div>
        ...
        <div className='flex justify-center'>
            <div className='shadow-[8px_35px_60px_15px_rgba(0,0,0,0.2)] mt-16 w-1/2 flex flex-col items-center rounded-xl'>
                <form action="" className='flex flex-col justify-center items-center'>
                    ...
                    <label className='border-2 border-[#dddada] w-1/2 mb-5 h-2/5'>
                        <input type="text" placeholder='Message' className='w-full text-xl p-2' />
                    </label>
