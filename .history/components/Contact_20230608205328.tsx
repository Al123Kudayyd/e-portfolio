  ...
  return (
    <div>
        ...
        <div className='flex justify-center'>
            <div className='shadow-[8px_8px_16px_15px_rgba(0,0,0,0.2)] mt-16 w-3/4 rounded-xl'>
                <form action="" className='flex flex-col justify-center items-center'>
                    ...
                    <label className='border-2 border-[#dddada] w-1/2 mb-5 h-40'>
                        <input type="text" placeholder='Message' className='w-full text-xl p-2 outline-none' />
                    </label>
                    <button className='bg-purple-500 border-purple-500 border-2 text-xl transition duration-300 w-1/2 mb-5 h-12 text-white font-bold hover:bg-white hover:text-purple-500'>
                        Send
                    </button>
                </form>
            </div>
