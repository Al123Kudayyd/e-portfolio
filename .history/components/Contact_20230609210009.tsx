        ...
        <div className='flex justify-center'>
            <div className='shadow-[8px_8px_16px_15px_rgba(0,0,0,0.2)] mt-16 w-1/2 rounded-xl'>
                <form action="" className='flex flex-col justify-center items-center my-5 '>
                    ...
                    <button className='bg-purple-500 border-purple-500 border-2 dark:hover:bg-transp text-xl transition duration-300 w-3/4 mb-5 h-12 text-white font-bold hover:bg-white hover:text-purple-500'>
                        Send
                    </button>
                </form>
            </div>
