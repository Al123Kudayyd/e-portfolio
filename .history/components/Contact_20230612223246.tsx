...
function Contact() {
    ...
    function load() {
        setLoading(true)
        setTimeout(() => {
            alert("contact me via email sammyahmed160@gmail.com")
        }, 1000)
        ...
        <div className='flex justify-center'>
            <div className='shadow-[8px_8px_16px_15px_rgba(0,0,0,0.2)] mt-16 w-5/6 md:w-1/2 rounded-xl'>
                <form action="" className='flex flex-col justify-center items-center my-5 '>
                    ...
                    {
                        loading ? <div className='bg-purple-500 border-purple-500 flex justify-center items-center text-xl border-2 dark:hover:bg-transparent text-xl transition duration-300 w-3/4 mb-5 h-12 text-white font-bold hover:bg-white hover:text-purple-500'><ImSpinner2 className='animate-spin' /></div> :
                        <button onClick={load} className='bg-purple-500 border-purple-500 border-2 dark:hover:bg-transparent text-xl transition duration-300 w-3/4 mb-5 h-12 text-white font-bold hover:bg-white hover:text-purple-500'>
                            Send
                        </button>
                    }
