    ...
    <div className='dark:bg-black dark:text-white py-20'>
        ...
        <div className='flex justify-center'>
            ...
            <form ref={form} onSubmit={sendEmail} className='flex flex-col justify-center items-center my-5 '>
                ...
                <input type="submit" value="Send" className='bg-purple-500 border-purple-500 border-2 dark:hover:bg-transparent text-xl transition duration-300 w-3/4 mb-5 h-12 text-white font-bold hover:bg-white hover:text-purple-500' />
            </form>
            </div>
        </div>
