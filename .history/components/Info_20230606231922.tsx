...
function Info() {
  return (
    <div className="overflow-hidden sp">
        <div className="space-y-10 my-11 flex-col text-center justify-center items-center">
          ...
          <div className="flex justify-center items-center space-x-3 text-3xl text-purple-500">
            <BsLinkedin />
            <AiTwotoneMail />
          </div>
        </div>
