...
function Info() {
  return (
    <div className="overflow-hidden">
        <div className="space-y-10 my-11 flex-col text-center justify-center items-center mx-2">
          ...
          <div className="flex justify-center items-center space-x-3 text-3xl text-purple-500 curs">
            <BsLinkedin />
            <AiTwotoneMail />
          </div>
        </div>
