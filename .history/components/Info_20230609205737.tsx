...
function Info() {
  return (
    <div className="overflow-hidden dark:overflow-hidden dark:bg-black py-56 md:py-48">
        <div className="space-y-10 flex-col text-center justify-center items-center">
          ...
          <div className="flex justify-center items-center space-x-3 text-3xl text-purple-500 cursor-pointer">
            <a href="https://www.linkedin.com/in/sammy-al-khudayyd-17656b246/"><BsLinkedin /></a>
            <a type='email' href=""><AiTwotoneMail /></a>
          </div>
