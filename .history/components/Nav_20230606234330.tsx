  ...
  return (
    <section className='bg-gradient-to-r from-violet-500 to-fuchsia-500'>
      <div className='py-5 mx-10 flex items-center justify-end font-bold cursor-pointer'>
        <FaBars className='flex md:hidden lg:hidden text-2xl hover:c transition' />
        <ul className='md:flex lg:flex hidden space-x-5 items-center justify-end text-xs sm:text-xl'>
            <li className='hover:c transition'>About Me</li>
            <li className='hover:c transition'>My Skills</li>
            <li className='hover:c transition'>Projects</li>
            <li className='hover:c transition'>Contact</li>
