  ...
  return (
    <section className='bg-gradient-to-r from-violet-500 to-fuchsia-500'>
      <div className='py-5 mx-10 flex items-center justify-end font-bold cursor-pointer'>
        <FaBars className='flex md:hidden lg:hidden text-2xl hover: transition' />
        <ul className='md:flex lg:flex hidden space-x-5 items-center justify-end text-xs sm:text-xl'>
            <li className='hover: transition'>About Me</li>
            <li className='hover: transition'>My Skills</li>
            <li className='hover: transition'>Projects</li>
            <li className='hover: transition'>Contact</li>
