          ...
          <div className='overscroll-y-none'>
            ...
            <div className=' w-screen h-screen md:hidden p-0 m-0 z-50 flex flex-col items-center justify-center'>  
              <ul className='space-y-16 text-white text-2xl'>
                ...
                <li onClick={() => setModal(false)} className='hover:text-black transition duration-300'><a href=""></a> My Skills</li>
                <li onClick={() => setModal(false)} className='hover:text-black transition duration-300'><a href=""></a> Projects</li>
