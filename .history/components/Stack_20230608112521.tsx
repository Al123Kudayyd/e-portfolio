import { SiHtml5, SiCss3, SiReact, SiNextdotjs, SiFirebase, SiRedux } from 'react-icons/si' 
          ...
          <h3 className='font-bold mb-10 text-3xl'><span className='text-purple-500'>Teachnologies</span> I've used</h3>
            <div className='flex flex-wrap items-center justify-center space-x-5'>
                ...
                <div className="onHover flex flex-col items-center text-[#F6820D]">
                    <SiFirebase className='text-5xl hover:scale-[.85] transition duration-300' />
                    <p className='text-sm font-semibold'>Firebase</p>
                </div>
                <div className="onHover flex flex-col items-center text-[#F6820D]">
                    <SiRedux className='text-5xl hover:scale-[.85] transition duration-300' />
                    <p className='text-sm font-semibold'>Firebase</p>
                </div>
              </div>
          </div>
