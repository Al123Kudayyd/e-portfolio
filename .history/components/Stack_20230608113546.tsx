import { SiHtml5, SiCss3, SiReact, SiNextdotjs, SiFirebase, SiRedux, SiJavascript, SiTypescript } from 'react-icons/si' 
  ...
  return (
    <div>
        ...
        <div>
          ...
          <div>
            <h3 className='text-center text-5xl font-bold'><span className='text-purple-500'>Languages</span> I've worked with</h3>
            <div className='flex flex-wrap items-center justify-center space-x-5'>
