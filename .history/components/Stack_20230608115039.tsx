        ...
        <div className='flex flex-col md:flex items-center justify-center'>
          ...
          <h3 className='font-bold mb-10 text-3xl'><span className='text-purple-500'>Teachnologies</span> I've used</h3>
            <div className='flex flex-wrap items-center justify-center space-x-5'>
                <div className="shadow-2xl shadow-[black] relative flex flex-col items-center text-[#F06529]">
                    <SiHtml5 className='absolute text-4xl hover:scale-[.85] transition duration-300' />
                    <p className='absolute top-14 text-sm font-semibold'>HTML</p>
                </div>
                <div className="relative shadow-2xl shadow-[black] px-6 py-2 flex flex-col items-center text-[#2965F1]">
