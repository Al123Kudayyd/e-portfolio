    ...
    <div>
        ...
        <div className='flex flex-col md:flex items-center justify-center'>
          ...
          <h3 className='font-bold mb-10 text-3xl'><span className='text-purple-500'>Teachnologies</span> I've used</h3>
            <div className='flex flex-wrap items-center justify-center space-x-5 rounded-sm'>
                <div className="shadow-2xl my-8 lg:my-0 px-6 py-3 shadow-[#2c2b2b] relative flex flex-col items-center text-[#F06529]">
