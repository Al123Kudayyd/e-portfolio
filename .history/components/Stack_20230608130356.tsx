...
function Stack() {
  return (
    <div>
        ...
        <div className='md:grid md:grid-cols items-center justify-center'>
          ...
          <h3 className='font-bold mx-8 my-8 text-3xl'><span className='text-purple-500'>Teachnologies</span> I've used</h3>
            <div className='grid grid-cols-3 items-center justify-center space-x-5 space-y-5'>
                <div className="relative shadow-2xl rounded-md shadow-[black] px-6 py-3 flex flex-col items-center text-[#F06529]">
