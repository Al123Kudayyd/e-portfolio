    ...
    <div>
        ...
        <div>
            <div className='flex flex-col items-center'>
                <h3 className='text-3xl font-bold space-y-20'><span className='text-purple-500'>Technologies</span> I've used</h3>
                <div className='text-[#F06529] shadow-xl shadow-[gray] flex flex-col items-center justify-center'>
                    <SiHtml5 />
                    <p>HTML</p>
                </div>
            </div>
